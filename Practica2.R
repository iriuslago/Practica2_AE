...
# 
# Seleccionando lambda mediante la regla de "un error est�ndar"
...
accuracy <- function(pred, obs, na.rm = FALSE,
  ...
  return(c(
    ...
    rmse = sqrt(mean(err^2)), # Ra�z del error cuadr�tico medio
...
# Ajustar un modelo mediante regresi�n spline adaptativa multivariante (MARS)
# empleando el m�todo "earth" del paquete caret.
